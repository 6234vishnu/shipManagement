...
const SupervisorLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post('/supervisor/auth/supervisor-login', formData);
        ...
        <div className="supervisorLoginPageCard">
          ...
          <div className="supervisorLoginPageForm">
            <div className="supervisorLoginPageInputGroup">
              <label className="supervisorLoginPageLabel" htmlFor="email">Email Address</label>
              <input
                type="email"
                id="email"
                name="email"
            ...
            <div className="supervisorLoginPageInputGroup">
              <label className="supervisorLoginPageLabel" htmlFor="password">Password</label>
              <input
                type="password"
                id="password"
                name="password"
            ...
            <div className="supervisorLoginPageOptions">
              <a href="#" className="supervisorLoginPageForgotPassword">Forgot Password?</a>
            </div>
