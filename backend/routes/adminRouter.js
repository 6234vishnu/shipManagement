...
import {
  ...
  editCateringItem,
  deleteCateringItem,
} from "../controllers/adminController/cateringController.js";
import {
  createfitnessCenterItem,
  getfitnessCenterItem,
  editfitnessCenterItem,
  deletefitnessCenterItem,
} from "../controllers/adminController/fitnessController.js";
import {
  createMoviesCenterItem,
  getMoviesCenterItem,
  editMoviesCenterItem,
  deleteMoviesCenterItem,
} from "../controllers/adminController/moviesController.js";
import {
  createPartyHallItem,
  getPartyHallItem,
  editPartyHallItem,
  deletePartyHallItem,
} from "../controllers/adminController/partyHallController.js";
import {
  createBeautySalonItem,
  getBeautySalonItem,
  editBeautySalonItem,
  deleteBeautySalonItem,
} from "../controllers/adminController/salonController.js";
import {
  createResortListItem,
  getResortListItem,
  editResortListItem,
  deleteResortListItem,
} from "../controllers/adminController/resortController.js";
import {
  createStationaryListItem,
  getStationaryListItem,
  editStationaryListItem,
  deleteStationaryListItem,
} from "../controllers/adminController/stationaryController.js";
...
adminRouter.post("/staffRequest-Approval", approveStaffRequest);
adminRouter.post("/staffRequest-Rejection", rejectStaffRequest);
...
adminRouter.post("/beautySalon-additem", createBeautySalonItem);
adminRouter.patch("/beautySalon-edititem", editBeautySalonItem);
adminRouter.delete("/beautySalon-deleteitem/:id", deleteBeautySalonItem);
adminRouter.get("/beautySalon-getItems", getBeautySalonItem);
