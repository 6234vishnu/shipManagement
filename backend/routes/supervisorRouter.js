...
import {
  supervisorLogin,
  supervisorLogout,
} from "../controllers/supervisorController/authController.js";
import {
  superviorStationaryList,
  updateDeliveryStatus,
} from "../controllers/supervisorController/activitiesController.js";
...
supervisorRouter.patch(
  "/stationary-orders/:orderId/deliver",
  updateDeliveryStatus
);
